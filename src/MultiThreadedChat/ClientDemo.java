    ...
    public void run()
        ...
        try {
          ...
          while(true) 
          {
           ...
           {
             String name= JOptionPane.showInputDialog(null,"enter name","name required",JOptionPane.INFORMATION_MESSAGE);
        
              pw.println(name);
              
               
           }
           else  if(msg.equalsIgnoreCase("NAMEALREADYEXITS"))
           {
              String name= JOptionPane.showInputDialog(null,"Enter other name","Name already exits",JOptionPane.WARNING_MESSAGE);
           ...
           else if(msg.equalsIgnoreCase("NAMEACCEPTED"))
           {
               lblLogin.setText(sc.nextLine());
